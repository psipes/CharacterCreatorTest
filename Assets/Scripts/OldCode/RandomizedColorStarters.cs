...
public class RandomizedColorStarters : MonoBehaviour
{
    //***********************************************************
    //
    //THIS SCRIPT IS MADE TO WORK WITH FACECARD SHADER AND MAT
    // IT ALSO USES A MATERIAL IN THE SECOND SLOT OF A MATERIAL ARRAY
    //
